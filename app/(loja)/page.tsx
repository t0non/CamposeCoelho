...
export const metadata: Metadata = {
  title: 'Central Atacado | Produtos para revenda e compras no atacado B2B',
  description:
    'Encontre produtos para revenda, cadastre seu CNPJ e consulte condições comerciais exclusivas para lojistas e empresas de todo o Brasil.',
  alternates: {
    canonical: 'http://localhost:3000',
  },
  openGraph: {
    title: 'Central Atacado | Plataforma de Atacado B2B',
    description:
